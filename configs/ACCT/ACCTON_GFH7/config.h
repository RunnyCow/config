...
#define SERVO1_PIN PC6 // TIM3_CH1
#define SERVO2_PIN PC7 // TIM3_CH2
#define SERVO3_PIN PC8 // TIM3_CH3
#define SERVO4_PIN PC9 // TIM3_CH4
...
#define TIMER_PIN_MAPPING \
   ...
   TIMER_PIN_MAP( 4, LED_STRIP_PIN,    1,  4) /* TIM2_CH3 */ \
   TIMER_PIN_MAP( 5, SERVO1_PIN,       1, -1) /* TIM3_CH1, No DMA */ \
   TIMER_PIN_MAP( 6, SERVO2_PIN,       1, -1) /* TIM3_CH2, No DMA */ \
   TIMER_PIN_MAP( 7, SERVO3_PIN,       1, -1) /* TIM3_CH3, No DMA */ \
   TIMER_PIN_MAP( 8, SERVO4_PIN,       1, -1) /* TIM3_CH4, No DMA */
...
#define DEFAULT_VOLTAGE_METER_SCALE      136
